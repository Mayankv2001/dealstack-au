...
/**
 * The ONE networked module of the gift-card ingest pipeline — a single
 * conditional GET of one permitted RSS/Atom feed URL.
 *
 ...
 * from the gift-card ingest entry points (the cron route and the manual
 * script), never from a request-handling page or public route.
 */
