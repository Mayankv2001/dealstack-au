...
## Done (6 — see TASK-INDEX.md for verification evidence)
TASK-TEST-001 · TASK-TEST-002 · TASK-GC-001 · TASK-DB-001 (all P1) · TASK-DOC-001 (P1) · TASK-SEO-001 (P3) — verified 2026-07-22.
...
## P1 — trust, data freshness, critical UX (3 open — exhaustive)
| Task | Why P1 |
|---|---|
...
Do P1 in this order: {CRON-003 ∥ CRON-001} → STACK-001. P2/P3 order is driven by file-conflict sequencing, not priority nuance — see TASK-DEPENDENCY-MAP.md.
