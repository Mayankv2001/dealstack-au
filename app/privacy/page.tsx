...
export default function PrivacyPage() {
  return (
    <PolicyPage title="Privacy" updated="13 July 2026">
      <section><h2>What the public site collects</h2><p>DealStack AU does not require a public account or collect payment details. Search terms remain in the page URL and are processed to return results.</p></section>
